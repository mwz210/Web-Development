  ...
  function registerVideoJsMarkersPlugin(options) {
    ...
    player.markers = {
      ...
      //  alert(player.currentTime());
        ...
        //    alert(markerTime);
            player.currentTime(markerTime);
        //    alert("player is now" + player.currentTime());
            return;
          }
        }
      },
      ...
      prev3 : function prev3(currentTime) {
      //  const currentTime = player.currentTime();
        for (var i = markersList.length - 1; i >= 0 ; i--) {
      ...
      findColor: function findColor(currentTime) {
        for (var i = 0; i < markersList.length; i++){
          console.log(markersList[i].class);
          var markerTime = setting.markerTip.time(markersList[i]);
          if (Math.abs(markerTime - currentTime) < 3){
            return markersList[i].class;
          }
        }
      },

      removeMarkerOne: function removeMarkerOne(currentTime) {
        var indexArray = [];
        var bool = false;
        for (var i = 0; i < markersList.length; i++) {
          var markerTime = setting.markerTip.time(markersList[i]);
      ...
      removeMarker: function removeMarker(currentTime) {
        ...
        for (var i = 0; i < markersList.length; i++) {
          ...
          if (Math.abs(markerTime - currentTime) < 3) {
            ...
            //indexArray.push(i);
            class_name = markersList[i].class;

          }
        }
        for (var i = 0; i < markersList.length; i++) {
          if (class_name == markersList[i].class) {
            indexArray.push(i);
            count += 1;
